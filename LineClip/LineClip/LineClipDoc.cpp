...
void CLineClipDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CLineClipDoc::InitializeSearchContent()
{
...
void CLineClipDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
