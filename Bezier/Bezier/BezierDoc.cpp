...
// 缩略图的支持
void CBezierDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CBezierDoc::InitializeSearchContent()
{
...
void CBezierDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
