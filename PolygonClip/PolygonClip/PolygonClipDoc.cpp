...
// PolygonClipDoc.cpp : CPolygonClipDoc 类的实现
//
...
// 缩略图的支持
void CPolygonClipDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CPolygonClipDoc::InitializeSearchContent()
{
...
void CPolygonClipDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
